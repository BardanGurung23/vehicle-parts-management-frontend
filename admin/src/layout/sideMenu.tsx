                  ...
                  each.menu.map((item, index) => (
                    <>
                      {viewAccess.includes(item.name) && (
                        <div
                          key={index}
                          className={`space-y-[0.25rem] mt-[0.25rem] flex items-center gap-[0.5rem] text-[#2F2B3D] hover:text-white px-[1.5rem] py-[0.5rem] rounded-[0.25rem] cursor-pointer hover:bg-gradient-to-r hover:from-[#e51d24] hover:to-[#f28b8d] ${
                            isActive === item.name ||
